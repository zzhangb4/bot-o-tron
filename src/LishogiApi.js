...
/**
 * Programatic interface to the web API of lishogi
 *  
 */
class LishogiApi {

  /**
   * Initialise with access token from https://lishogi.org/account/oauth/token/create.
   */
 
  constructor(token) {
    this.baseURL = "https://lishogi.org/";
